...
class B1Z1Base(RewardVecTask):
    ...
    def _init_tensors(self):
        ...
        self.gripper_idx = self.gym.find_actor_rigid_body_index(self.envs[0], self.robot_handles[0], "zarx_body7", gymapi.DOMAIN_ENV)
        ...
        self.wrist_idx = self.gym.find_actor_rigid_body_index(self.envs[0], self.robot_handles[0], "zarx_body6", gymapi.DOMAIN_ENV)
        self.flange_idx = self.gym.find_actor_rigid_body_index(self.envs[0], self.robot_handles[0], "zarx_body5", gymapi.DOMAIN_ENV)
    ...
    def _set_default_joint_angles_dict(self):
        ...
        if self.floating_base:
            ...
            default_joint_angles = { # = target angles [rad] when action = 0.0
                ...
                'z1_forearm_roll': 0.0,
                'z1_wrist_rotate': 0.,#1.57, # 0.0,
                'z1_jointGripper': 0.,#-1.57, # -0.785,
            }
